...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	// Watch for changes to secondary resource Pods and requeue the owner Vip
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &egressv1alpha1.Vip{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileVip) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	// Set Vip instance as the owner and controller
...
func newPodForCR(cr *egressv1alpha1.Vip) *corev1.Pod {
