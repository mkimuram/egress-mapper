...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	// Watch for changes to secondary resource Pods and requeue the owner Egress
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &egressv1alpha1.Egress{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileEgress) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	// Set Egress instance as the owner and controller
...
func newPodForCR(cr *egressv1alpha1.Egress) *corev1.Pod {
